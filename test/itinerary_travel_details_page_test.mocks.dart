...
// in travel_planner_project/test/itinerary_travel_details_page_test.dart.
...
import 'package:travel_planner_project/model/attraction.dart' as _i13;
import 'package:travel_planner_project/model/destination.dart' as _i11;
import 'package:travel_planner_project/model/expense.dart' as _i12;
import 'package:travel_planner_project/model/travel_details.dart' as _i9;
import 'package:travel_planner_project/travel_details_provider.dart' as _i10;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTravelDetailsProvider extends _i1.Mock
    implements _i10.TravelDetailsProvider {
  MockTravelDetailsProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i11.Destination> get destinations => (super.noSuchMethod(
        Invocation.getter(#destinations),
        returnValue: <_i11.Destination>[],
      ) as List<_i11.Destination>);

  @override
  List<_i9.TravelDetails> get travelDetail => (super.noSuchMethod(
        Invocation.getter(#travelDetail),
        returnValue: <_i9.TravelDetails>[],
      ) as List<_i9.TravelDetails>);

  @override
  List<_i12.Expense> get expenses => (super.noSuchMethod(
        Invocation.getter(#expenses),
        returnValue: <_i12.Expense>[],
      ) as List<_i12.Expense>);

  @override
  double get budget => (super.noSuchMethod(
        Invocation.getter(#budget),
        returnValue: 0.0,
      ) as double);
  ...
  @override
  _i6.Future<void> fetchTravelDetails() => (super.noSuchMethod(
        Invocation.method(
          #fetchTravelDetails,
          [],
        ),
  ...
  @override
  _i6.Future<void> fetchDestinations() => (super.noSuchMethod(
        Invocation.method(
          #fetchDestinations,
          [],
        ),
  ...
  @override
  _i6.Future<void> setTravelDetailsId(String? travelDetailsId) =>
      (super.noSuchMethod(
        Invocation.method(
          #setTravelDetailsId,
          [travelDetailsId],
  ...
  @override
  _i6.Future<void> addTravelDetails(_i9.TravelDetails? travelDetail) =>
      (super.noSuchMethod(
        Invocation.method(
          #addTravelDetails,
          [travelDetail],
  ...
  @override
  _i6.Future<void> deleteTravelDetails(_i9.TravelDetails? travelDetail) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteTravelDetails,
          [travelDetail],
  ...
  @override
  _i6.Future<void> updateTravelDetails(_i9.TravelDetails? travelDetail) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateTravelDetails,
          [travelDetail],
  ...
  @override
  _i6.Future<void> updateTravelDetailsByTravelDetails(
          _i9.TravelDetails? updatedTravelDetails) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateTravelDetailsByTravelDetails,
  ...
  @override
  _i6.Future<void> loadExpenses(String? travelDetailsId) => (super.noSuchMethod(
        Invocation.method(
          #loadExpenses,
          [travelDetailsId],
        ),
  ...
  @override
  _i6.Future<void> addExpense(_i12.Expense? expense) => (super.noSuchMethod(
        Invocation.method(
          #addExpense,
          [expense],
        ),
  ...
  @override
  _i6.Future<void> deleteExpense(_i12.Expense? expense) => (super.noSuchMethod(
        Invocation.method(
          #deleteExpense,
          [expense],
        ),
  ...
  @override
  _i6.Future<void> updateExpense(_i12.Expense? expense) => (super.noSuchMethod(
        Invocation.method(
          #updateExpense,
          [expense],
        ),
  ...
  @override
  void updateBudget(double? newBudget) => super.noSuchMethod(
        Invocation.method(
          #updateBudget,
          [newBudget],
        ),
  ...
  @override
  _i6.Future<_i13.Attraction?> getAttractionDetails(int? attractionId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAttractionDetails,
          [attractionId],
        ),
        returnValue: _i6.Future<_i13.Attraction?>.value(),
      ) as _i6.Future<_i13.Attraction?>);
